...
export default function DeleteModal({ target, loading, onConfirm, onClose }: Props) {
  ...
  return (
    <Modal open={true} onClose={loading ? () => {} : onClose} size="md">
      <h3 className="text-xl font-bold text-gray-800 dark:text-dm-text mb-2">
        Excluir {member.name}
      </h3>

      {expenseCount > 0 ? (
        <>
          <p className="text-gray-600 dark:text-dm-muted text-sm mb-6">
            Este membro possui{' '}
          ...
          <div className="space-y-3 mb-4">
            ...
            >
              ...
              <p className="text-sm text-gray-500 dark:text-dm-muted mt-0.5">
