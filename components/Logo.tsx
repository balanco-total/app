export default function Logo({ width = 181, height = 56 }: { width?: number; height?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 172 56" width={width} height={height} aria-label="BalançoTotal">
      ...
      <rect x="13" y="40" width="7" height="8" rx="1.5" className="fill-accent dark:fill-dm-card"/>
      <rect x="23" y="35" width="7" height="13" rx="1.5" className="fill-accent dark:fill-dm-card"/>
      <rect x="33" y="29" width="7" height="19" rx="1.5" className="fill-accent dark:fill-dm-card"/>
