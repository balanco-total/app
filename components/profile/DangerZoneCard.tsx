...
export default function DangerZoneCard() {
  ...
  return (
    <>
      <div className="bg-white dark:bg-dm-card rounded-2xl shadow-lg p-6 border-2 border-red-100 dark:border-red-900/50">
      ...
      <Modal
        ...
        size="md"
      >
        <h3 className="text-xl font-bold text-gray-800 dark:text-dm-text mb-2">Excluir todos os lançamentos</h3>
        <p className="text-gray-600 dark:text-dm-muted text-sm mb-4">
          Esta ação é <strong>irreversível</strong> e removerá todos os lançamentos de todos os membros da conta.
        </p>
        <p className="text-sm text-gray-700 dark:text-dm-muted mb-2">
      ...
      >
        ...
        <p className="text-gray-600 dark:text-dm-muted text-sm mb-2">
          Esta ação é <strong>irreversível</strong> e irá remover:
        </p>
        <ul className="text-sm text-gray-600 dark:text-dm-muted list-disc list-inside mb-4 space-y-1">
