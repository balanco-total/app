...
function ChartCardSkeleton({ height }: { height: number }) {
  return (
    <div className="bg-white dark:bg-dm-card rounded-2xl shadow-lg p-6">
      <div className="h-6 w-48 bg-gray-100 dark:bg-dm-surface rounded mb-4 animate-pulse" />
      <div className="bg-gray-50 dark:bg-dm-surface rounded-xl animate-pulse" style={{ height }} />
    </div>
  )
}
