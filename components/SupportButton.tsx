      ...
      >
        {sent ? (
          <div className="flex flex-col items-center text-center py-4 gap-3">
            ...
            <p className="text-gray-700">Recebemos sua mensagem! Responderemos no seu e-mail em breve.</p>
          </div>
        ) : (
          <div className="space-y-4">
            <div>
              <label htmlFor="support-category" className="block text-sm font-medium text-gray-700 mb-1.5">
                Categoria
              </label>
              <select
                id="support-category"
                ...
                disabled={loading}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-transparent text-sm text-gray-700"
              >
                {CATEGORIES.map(c => (
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-transparent text-sm text-gray-700 resize-none"
              />
