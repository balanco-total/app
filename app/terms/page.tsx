  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Termos de Uso</h1>
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">1. Aceitação dos termos</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">2. Descrição do serviço</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">3. Plano e pagamento</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">4. Cancelamento e reembolso</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">5. Responsabilidades do usuário</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">6. Proibições de uso</h2>
            <p>É vedado:</p>
            <ul className="list-disc pl-5 space-y-2 mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">7. Limitação de responsabilidade</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">8. Disponibilidade do serviço</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">9. Propriedade intelectual</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">10. Alterações e encerramento</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">11. Lei aplicável e foro</h2>
            <p>
