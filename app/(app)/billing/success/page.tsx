...
export default async function BillingSuccessPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dm-surface flex items-center justify-center p-4">
      <div className="bg-white dark:bg-dm-card rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
        <CheckCircle2 size={56} className="text-emerald-500 mx-auto mb-4" />
        <h1 className="text-2xl font-bold text-gray-800 dark:text-dm-text mb-2">Assinatura confirmada!</h1>
